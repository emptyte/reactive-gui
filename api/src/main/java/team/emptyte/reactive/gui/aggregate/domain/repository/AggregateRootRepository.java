 ...
 */
package team.emptyte.reactive.gui.aggregate.domain.repository;
...
import team.emptyte.reactive.gui.aggregate.domain.AggregateRoot;
...
public interface AggregateRootRepository<AggregateType extends AggregateRoot> extends Iterable<AggregateType> {
   ...
   * {@link #deleteAndRetrieveSync(String)}. Also, this method can delete it permanently the {@link AggregateType}
